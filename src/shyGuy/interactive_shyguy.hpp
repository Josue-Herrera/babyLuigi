...
class interactive_shyguy {
    ...
    //  main page ->
public:
    static std::vector<std::vector<ftxui::ColorInfo>> ColorInfoSorted2D() {
  ...
  auto htop = Renderer([&] {
    auto frequency = vbox({
        ...
        hbox({
            ...
            ftxui::graph(std::ref(my_graph)) | flex,
        }) | flex,
    });
    ...
    auto utilization = vbox({
        ...
        hbox({
            ...
            ftxui::graph(std::ref(my_graph)) | color(Color::RedLight),
        }) | flex,
    });
    ...
    auto ram = vbox({
        ...
        hbox({
            ...
            ftxui::graph(std::ref(my_graph)) | color(Color::BlueLight),
        }) | flex,
    });
