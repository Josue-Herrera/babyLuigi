...
namespace cosmos::inline v1
{
    ...
    public:
        explicit interactive_shyguy(concurrent_shyguy &in):
            shyguy{in}
        {
        };
        ...
        inline auto demo()
        {
            ...
            auto action_selection = Menu(&action_entries, reinterpret_cast<int *>(&action_index),
            ...
            auto dag_selection = Menu(&dag_entries, reinterpret_cast<int *>(&dag_index),
                                      MenuOption::HorizontalAnimated());
